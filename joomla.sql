...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-04-2014 a las 18:53:51
...
--
-- Estructura de tabla para la tabla `icancarry_assets`
--

CREATE TABLE IF NOT EXISTS `icancarry_assets` (
...
--
-- Volcado de datos para la tabla `icancarry_assets`
--

INSERT INTO `icancarry_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Estructura de tabla para la tabla `icancarry_associations`
--

CREATE TABLE IF NOT EXISTS `icancarry_associations` (
...
--
-- Estructura de tabla para la tabla `icancarry_banners`
--

CREATE TABLE IF NOT EXISTS `icancarry_banners` (
...
--
-- Estructura de tabla para la tabla `icancarry_banner_clients`
--

CREATE TABLE IF NOT EXISTS `icancarry_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Volcado de datos para la tabla `icancarry_banner_clients`
--

INSERT INTO `icancarry_banner_clients` (`id`, `name`, `contact`, `email`, `extrainfo`, `state`, `checked_out`, `checked_out_time`, `metakey`, `own_prefix`, `metakey_prefix`, `purchase_type`, `track_clicks`, `track_impressions`) VALUES
...
--
-- Estructura de tabla para la tabla `icancarry_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `icancarry_banner_tracks` (
...
--
-- Estructura de tabla para la tabla `icancarry_categories`
--

CREATE TABLE IF NOT EXISTS `icancarry_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `icancarry_categories`
--

INSERT INTO `icancarry_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 13, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 620, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Sin categoría', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 620, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Sin categoría', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":"","foobar":""}', '', '', '{"page_title":"","author":"","robots":""}', 620, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Sin categoría', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 620, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Sin categoría', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 620, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(6, 31, 1, 9, 10, 1, 'uncategorised', 'com_weblinks', 'Sin categoría', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 620, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 11, 12, 1, 'uncategorised', 'com_users', 'Sin categoría', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 620, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `icancarry_contact_details`
--

CREATE TABLE IF NOT EXISTS `icancarry_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `icancarry_content`
--

CREATE TABLE IF NOT EXISTS `icancarry_content` (
...
--
-- Volcado de datos para la tabla `icancarry_contentitem_tag_map`
--

INSERT INTO `icancarry_contentitem_tag_map` (`type_alias`, `core_content_id`, `content_item_id`, `tag_id`, `tag_date`, `type_id`) VALUES
('com_content.article', 1, 1, 2, '2013-11-16 06:00:00', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `icancarry_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `icancarry_content_frontpage` (
...
--
-- Estructura de tabla para la tabla `icancarry_content_rating`
--

CREATE TABLE IF NOT EXISTS `icancarry_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `icancarry_content_types`
--

CREATE TABLE IF NOT EXISTS `icancarry_content_types` (
...
--
-- Volcado de datos para la tabla `icancarry_content_types`
--

INSERT INTO `icancarry_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Estructura de tabla para la tabla `icancarry_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `icancarry_core_log_searches` (
...
--
-- Estructura de tabla para la tabla `icancarry_extensions`
--

CREATE TABLE IF NOT EXISTS `icancarry_extensions` (
...
--
-- Volcado de datos para la tabla `icancarry_extensions`
--

INSERT INTO `icancarry_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2014 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":""}', '{"mediaversion":"be9210e37c43f73a5a3784818c06cebb"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Estructura de tabla para la tabla `icancarry_finder_links`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_links` (
...
--
-- Estructura de tabla para la tabla `icancarry_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_links_terms0` (
...
--
-- Estructura de tabla para la tabla `icancarry_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `icancarry_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `icancarry_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `icancarry_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `icancarry_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `icancarry_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `icancarry_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `icancarry_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `icancarry_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `icancarry_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `icancarry_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `icancarry_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `icancarry_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `icancarry_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `icancarry_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `icancarry_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Volcado de datos para la tabla `icancarry_finder_taxonomy`
--

INSERT INTO `icancarry_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `icancarry_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `icancarry_finder_terms`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_terms` (
...
--
-- Estructura de tabla para la tabla `icancarry_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Volcado de datos para la tabla `icancarry_finder_terms_common`
--

INSERT INTO `icancarry_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Estructura de tabla para la tabla `icancarry_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `icancarry_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `icancarry_finder_types`
--

CREATE TABLE IF NOT EXISTS `icancarry_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `icancarry_languages`
--

CREATE TABLE IF NOT EXISTS `icancarry_languages` (
...
--
-- Volcado de datos para la tabla `icancarry_languages`
--

INSERT INTO `icancarry_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
...
--
-- Estructura de tabla para la tabla `icancarry_menu`
--

CREATE TABLE IF NOT EXISTS `icancarry_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `icancarry_menu`
--

INSERT INTO `icancarry_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(7, 'menu', 'com_contact', 'Contactos', '', 'Contactos', 'index.php?option=com_contact', 'component', 0, 1, 1, 8, 0, '0000-00-00 00:00:00', 0, 0, 'class:contact', 0, '', 23, 28, 0, '*', 1),
(8, 'menu', 'com_contact', 'Contactos', '', 'Contactos/Contactos', 'index.php?option=com_contact', 'component', 0, 7, 2, 8, 0, '0000-00-00 00:00:00', 0, 0, 'class:contact', 0, '', 24, 25, 0, '*', 1),
(9, 'menu', 'com_contact_categories', 'Categorías', '', 'Contactos/Categorías', 'index.php?option=com_categories&extension=com_contact', 'component', 0, 7, 2, 6, 0, '0000-00-00 00:00:00', 0, 0, 'class:contact-cat', 0, '', 26, 27, 0, '*', 1),
(10, 'menu', 'com_messages', 'Mensajes', '', 'Mensajes', 'index.php?option=com_messages', 'component', 0, 1, 1, 15, 0, '0000-00-00 00:00:00', 0, 0, 'class:messages', 0, '', 29, 34, 0, '*', 1),
(11, 'menu', 'com_messages_add', 'Nuevo mensaje privado', '', 'Mensajes/Nuevo mensaje privado', 'index.php?option=com_messages&task=message.add', 'component', 0, 10, 2, 15, 0, '0000-00-00 00:00:00', 0, 0, 'class:messages-add', 0, '', 30, 31, 0, '*', 1),
(12, 'menu', 'com_messages_read', 'Leer mensaje privado', '', 'Mensajes/Leer mensaje privado', 'index.php?option=com_messages', 'component', 0, 10, 2, 15, 0, '0000-00-00 00:00:00', 0, 0, 'class:messages-read', 0, '', 32, 33, 0, '*', 1),
...
(15, 'menu', 'com_newsfeeds_categories', 'Categorías', '', 'News Feeds/Categorías', 'index.php?option=com_categories&extension=com_newsfeeds', 'component', 0, 13, 2, 6, 0, '0000-00-00 00:00:00', 0, 0, 'class:newsfeeds-cat', 0, '', 38, 39, 0, '*', 1),
(16, 'menu', 'com_redirect', 'Redirección', '', 'Redirección', 'index.php?option=com_redirect', 'component', 0, 1, 1, 24, 0, '0000-00-00 00:00:00', 0, 0, 'class:redirect', 0, '', 41, 42, 0, '*', 1),
(17, 'menu', 'com_search', 'Búsqueda básica', '', 'Búsqueda básica', 'index.php?option=com_search', 'component', 0, 1, 1, 19, 0, '0000-00-00 00:00:00', 0, 0, 'class:search', 0, '', 43, 44, 0, '*', 1),
(18, 'menu', 'com_weblinks', 'Enlaces Web', '', 'Enlaces Web', 'index.php?option=com_weblinks', 'component', 0, 1, 1, 21, 0, '0000-00-00 00:00:00', 0, 0, 'class:weblinks', 0, '', 45, 50, 0, '*', 1),
(19, 'menu', 'com_weblinks_links', 'Links', '', 'Enlaces Web/Enlaces', 'index.php?option=com_weblinks', 'component', 0, 18, 2, 21, 0, '0000-00-00 00:00:00', 0, 0, 'class:weblinks', 0, '', 46, 47, 0, '*', 1),
(20, 'menu', 'com_weblinks_categories', 'Categorías', '', 'Enlaces Web/Categorías', 'index.php?option=com_categories&extension=com_weblinks', 'component', 0, 18, 2, 6, 0, '0000-00-00 00:00:00', 0, 0, 'class:weblinks-cat', 0, '', 48, 49, 0, '*', 1),
(21, 'menu', 'com_finder', 'Búsqueda Inteligente', '', 'Búsqueda Inteligente', 'index.php?option=com_finder', 'component', 0, 1, 1, 27, 0, '0000-00-00 00:00:00', 0, 0, 'class:finder', 0, '', 51, 52, 0, '*', 1),
(22, 'menu', 'com_joomlaupdate', 'Actualizar Joomla!', '', 'Actualizar Joomla!', 'index.php?option=com_joomlaupdate', 'component', 1, 1, 1, 28, 0, '0000-00-00 00:00:00', 0, 0, 'class:joomlaupdate', 0, '', 53, 54, 0, '*', 1),
(23, 'main', 'com_tags', 'Etiquetas', '', 'Etiquetas', 'index.php?option=com_tags', 'component', 0, 1, 1, 29, 0, '0000-00-00 00:00:00', 0, 1, 'class:tags', 0, '', 55, 56, 0, '', 1),
(24, 'main', 'com_postinstall', 'Mensajes posteriores a la instalación', '', 'Mensajes posteriores a la instalación', 'index.php?option=com_postinstall', 'component', 0, 1, 1, 32, 0, '0000-00-00 00:00:00', 0, 1, 'class:postinstall', 0, '', 57, 58, 0, '*', 1),
(101, 'mainmenu', 'Inicio', 'inicio-portal', '', 'inicio-portal', 'index.php?option=com_content&view=article&id=1', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_title":"1","link_titles":"","show_intro":"","info_block_position":"0","show_category":"0","link_category":"0","show_parent_category":"0","link_parent_category":"0","show_author":"0","link_author":"0","show_create_date":"0","show_modify_date":"0","show_publish_date":"0","show_item_navigation":"0","show_vote":"","show_tags":"","show_icons":"0","show_print_icon":"0","show_email_icon":"0","show_hits":"0","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 59, 60, 1, '*', 0),
(102, 'usermenu', 'Su perfil', 'su-perfil', '', 'su-perfil', 'index.php?option=com_users&view=profile&layout=edit', 'component', 1, 1, 1, 25, 0, '0000-00-00 00:00:00', 0, 2, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 11, 12, 0, '*', 0),
(103, 'usermenu', 'Zona Administración', 'sitio-administrador', '', 'sitio-administrador', 'administrator', 'url', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 6, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1}', 17, 18, 0, '*', 0),
(104, 'usermenu', 'Enviar un Artículo', 'enviar-un-articulo', '', 'v', 'index.php?option=com_content&view=form&layout=edit', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 3, '', 0, '{"enable_category":"0","catid":"2","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 13, 14, 0, '*', 0),
(105, 'usermenu', 'Enviar un enlace Web', 'enviar-un-enlace-web', '', 'enviar-un-enlace-web', 'index.php?option=com_weblinks&view=form&layout=edit', 'component', 1, 1, 1, 21, 0, '0000-00-00 00:00:00', 0, 3, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 15, 16, 0, '*', 0),
(106, 'usermenu', 'Configuración de plantilla', 'configuracion-de-plantilla', '', 'configuracion-de-plantilla', 'index.php?option=com_config&view=templates&controller=config.display.templates', 'component', 1, 1, 1, 23, 0, '0000-00-00 00:00:00', 0, 6, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 19, 20, 0, '*', 0),
(107, 'usermenu', 'Configuración del siio', 'configuracion-del-sitio', '', 'configuracion-del-sitio', 'index.php?option=com_config&view=config&controller=config.display.config', 'component', 1, 1, 1, 23, 0, '0000-00-00 00:00:00', 0, 6, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 21, 22, 0, '*', 0),
(108, 'mainmenu', 'Servicios', 'servicios', '', 'servicios', 'index.php?option=com_content&view=category&id=2', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_category_title":"","show_description":"","show_description_image":"","maxLevel":"","show_empty_categories":"","show_no_articles":"","show_category_heading_title":"","show_subcat_desc":"","show_cat_num_articles":"","show_tags":"","page_subheading":"","show_pagination_limit":"","filter_field":"","show_headings":"","list_show_date":"","date_format":"","list_show_hits":"","list_show_author":"","orderby_pri":"","orderby_sec":"","order_date":"","show_pagination":"","show_pagination_results":"","display_num":"10","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","show_feed_link":"","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 61, 62, 0, '*', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `icancarry_menu_types`
--

CREATE TABLE IF NOT EXISTS `icancarry_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `icancarry_menu_types`
--

INSERT INTO `icancarry_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Menú principal', 'Menú principal del sitio web'),
(2, 'usermenu', 'Menú de Usuario', 'Un Menú para usuarios registrados');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `icancarry_messages`
--

CREATE TABLE IF NOT EXISTS `icancarry_messages` (
...
--
-- Estructura de tabla para la tabla `icancarry_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `icancarry_messages_cfg` (
...
--
-- Estructura de tabla para la tabla `icancarry_modules`
--

CREATE TABLE IF NOT EXISTS `icancarry_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Volcado de datos para la tabla `icancarry_modules`
--

INSERT INTO `icancarry_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(2, 40, 'Acceder', '', '', 1, 'login', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_login', 1, 1, '', 1, '*'),
(3, 41, 'Artículos Populares', '', '', 3, 'cpanel', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_popular', 3, 1, '{"count":"5","catid":"","user_id":"0","layout":"_:default","moduleclass_sfx":"","cache":"0","automatic_title":"1"}', 1, '*'),
(4, 42, 'Artículos añadidos recientemente', '', '', 4, 'cpanel', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_latest', 3, 1, '{"count":"5","ordering":"c_dsc","catid":"","user_id":"0","layout":"_:default","moduleclass_sfx":"","cache":"0","automatic_title":"1"}', 1, '*'),
(8, 43, 'Barra de Herramientas', '', '', 1, 'toolbar', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_toolbar', 3, 1, '', 1, '*'),
(9, 44, 'Iconos rápidos', '', '', 1, 'icon', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_quickicon', 3, 1, '', 1, '*'),
(10, 45, 'Usuarios registrados', '', '', 2, 'cpanel', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_logged', 3, 1, '{"count":"5","name":"1","layout":"_:default","moduleclass_sfx":"","cache":"0","automatic_title":"1"}', 1, '*'),
(12, 46, 'Admin Menú', '', '', 1, 'menu', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 3, 1, '{"layout":"","moduleclass_sfx":"","shownew":"1","showhelp":"1","cache":"0"}', 1, '*'),
(13, 47, 'Admin Submenú', '', '', 1, 'submenu', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_submenu', 3, 1, '', 1, '*'),
(14, 48, 'Estado Usuario', '', '', 2, 'status', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_status', 3, 1, '', 1, '*'),
(15, 49, 'Título', '', '', 1, 'title', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_title', 3, 1, '', 1, '*'),
(16, 50, 'Formulario de acceso', '', '', 7, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_login', 1, 1, '{"greeting":"1","name":"0"}', 0, '*'),
...
--
-- Volcado de datos para la tabla `icancarry_modules_menu`
--

INSERT INTO `icancarry_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Estructura de tabla para la tabla `icancarry_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `icancarry_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `icancarry_overrider`
--

CREATE TABLE IF NOT EXISTS `icancarry_overrider` (
...
--
-- Estructura de tabla para la tabla `icancarry_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `icancarry_postinstall_messages` (
...
--
-- Volcado de datos para la tabla `icancarry_postinstall_messages`
--

INSERT INTO `icancarry_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Estructura de tabla para la tabla `icancarry_redirect_links`
--

CREATE TABLE IF NOT EXISTS `icancarry_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `icancarry_schemas`
--

CREATE TABLE IF NOT EXISTS `icancarry_schemas` (
...
--
-- Volcado de datos para la tabla `icancarry_schemas`
--

INSERT INTO `icancarry_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.2.3-2014-02-20');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `icancarry_session`
--

CREATE TABLE IF NOT EXISTS `icancarry_session` (
...
--
-- Volcado de datos para la tabla `icancarry_session`
--

INSERT INTO `icancarry_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('nofqb48ojk6kctqj1q6osj4n32', 1, 0, '1397667075', '__default|a:8:{s:15:"session.counter";i:40;s:19:"session.timer.start";i:1397665781;s:18:"session.timer.last";i:1397667073;s:17:"session.timer.now";i:1397667074;s:22:"session.client.browser";s:109:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1847.116 Safari/537.36";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":7:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}s:13:"com_installer";O:8:"stdClass":3:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";s:12:"redirect_url";N;}s:16:"com_joomlaupdate";O:8:"stdClass":3:{s:4:"file";N;s:8:"password";s:32:"L4JR6GuQi6noOooWzTYw81FssGe6LADV";s:8:"filesize";i:4565764;}s:10:"com_config";O:8:"stdClass":1:{s:6:"config";O:8:"stdClass":1:{s:6:"global";O:8:"stdClass":1:{s:4:"data";N;}}}s:13:"com_templates";O:8:"stdClass":1:{s:4:"edit";O:8:"stdClass":1:{s:5:"style";O:8:"stdClass":2:{s:2:"id";a:0:{}s:4:"data";N;}}}s:9:"com_menus";O:8:"stdClass":1:{s:4:"edit";O:8:"stdClass":1:{s:4:"item";O:8:"stdClass":3:{s:4:"type";N;s:4:"link";N;s:4:"data";N;}}}s:11:"com_modules";O:8:"stdClass":2:{s:7:"modules";O:8:"stdClass":1:{s:6:"filter";O:8:"stdClass":1:{s:18:"client_id_previous";i:0;}}s:4:"edit";O:8:"stdClass":1:{s:6:"module";O:8:"stdClass":2:{s:2:"id";a:2:{i:0;i:95;i:1;i:96;}s:4:"data";N;}}}}}s:4:"user";O:5:"JUser":26:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"620";s:4:"name";s:13:"Super Usuario";s:8:"username";s:5:"admin";s:5:"email";s:24:"jjlabradorglez@gmail.com";s:8:"password";s:34:"$P$DWbnuFCe4D8zrDZ7QQU0WqQvhEb8sU.";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2014-04-16 16:27:41";s:13:"lastvisitDate";s:19:"0000-00-00 00:00:00";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:5:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:6;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;s:6:"otpKey";s:0:"";s:4:"otep";s:0:"";}s:13:"session.token";s:32:"8d5a942f323c43c8211c3770a05545e0";}', 620, 'admin'),
('o1fi3v62ld9hcdckobg67639b1', 0, 1, '1397666860', '__default|a:8:{s:15:"session.counter";i:12;s:19:"session.timer.start";i:1397665777;s:18:"session.timer.last";i:1397666858;s:17:"session.timer.now";i:1397666859;s:22:"session.client.browser";s:109:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1847.116 Safari/537.36";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:2:"13";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:1:{i:0;s:1:"1";}s:14:"\\0\\0\\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"9cd3c7bde564e499d155ed98a5fcaa51";}admin_change|b:1;', 0, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `icancarry_tags`
--

CREATE TABLE IF NOT EXISTS `icancarry_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `icancarry_tags`
--

INSERT INTO `icancarry_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 620, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, 1, 1, 2, 1, 'joomla', 'Joomla', 'joomla', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"tag_layout":"","tag_link_class":"label label-info","image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '', '', '{"author":"","robots":""}', 620, '2013-11-16 00:00:00', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `icancarry_template_styles`
--

CREATE TABLE IF NOT EXISTS `icancarry_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `icancarry_template_styles`
--

INSERT INTO `icancarry_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
(9, 'yougrids', 0, '1', 'Yougrids - Defecto', '{"custom_css":"2","yjsg_get_styles":"blue|007ebd","default_font":"12px","default_font_family":"6","selectors_override":"1","selectors_override_type":"3","fontfacekit_font_family":"PTSansNarrowBold","logo_image":"","logo_width":"300px","logo_height":"125px","turn_logo_off":"2","turn_header_block_off":"2","menuName":"mainmenu","default_menu_style":"2","sub_width":"200px","yjsg_menu_offset":"95","css_widthdefined":"px","css_width":"1200","site_layout":"2","widthdefined":"%","maincolumn":"55","insetcolumn":"0","leftcolumn":"22.5","rightcolumn":"22.5","widthdefined_itmid":"%","maincolumn_itmid":"46","insetcolumn_itmid":"18","leftcolumn_itmid":"18","rightcolumn_itmid":"18","yjsg_1_width":"20|20|20|20|20|0|0|0|0|0","yjsg_header_width":"33|33|33|0|0|0","yjsg_2_width":"20|20|20|20|20|0|0|0|0|0","yjsg_3_width":"20|20|20|20|20|0|0|0|0|0","yjsg_4_width":"20|20|20|20|20|0|0|0|0|0","yjsg_bodytop_width":"33|33|33|0|0|0","yjsg_yjsgbodytbottom_width":"33|33|33|0|0|0","yjsg_5_width":"20|20|20|20|20|0|0|0|0|0","yjsg_6_width":"20|20|20|20|20|0|0|0|0|0","yjsg_7_width":"20|20|20|20|20|0|0|0|0|0","ga_switch":"0","GAcode":"Your google code","ie6notice":"0","nonscript":"0","show_tools":"1","show_fres":"1","show_rtlc":"1","text_direction":"2","turn_seo_off":"2","videojs_on":"0","videojs_vimeo_on":"0","videojs_youtube_on":"0","branding_off":"2","joomlacredit_off":"1","custom_cp":"","joomla_generator_off":"1","validators_off":"1","totop_off":"1","tpopen_text":"Open","tpclose_text":"Close","tpbtn_height":"30","tpbtn_width":"100","tptran_speed":"500","yjsg_toppanel_width":"20|20|20|20|20|0|0|0|0|0","toppanel_module_style":"YJsgxhtml","bpopen_text":"Open","bpclose_text":"Close","bpbtn_height":"30","bpbtn_width":"100","bptran_speed":"500","yjsg_botpanel_width":"20|20|20|20|20|0|0|0|0|0","botpanel_module_style":"YJsgxhtml","spbox_width":"350","spbtn_poz":"45%","sptran_speed":"500","sidepanel_module_style":"YJsgxhtml","responsive_on":"1","less_compiler_on":"1","compile_css":"1","compiler_compressed":"1","use_compiled_css":"0","ajax_front_recompile":"1","buffer_front_recompile":"0","fp_controll_switch":"2","fp_chars_limit":"3000","fp_after_text":"","jq_switch":"2","YJsg1_module_style":"YJsgxhtml","YJsgh_module_style":"YJsgxhtml","YJsg2_module_style":"YJsgxhtml","YJsg3_module_style":"YJsgxhtml","YJsg4_module_style":"YJsgxhtml","YJsgmt_module_style":"YJsgxhtml","YJsgl_module_style":"YJsgxhtml","YJsgr_module_style":"YJsgxhtml","YJsgi_module_style":"YJsgxhtml","YJsgit_module_style":"YJsgxhtml","YJsgib_module_style":"YJsgxhtml","YJsgmb_module_style":"YJsgxhtml","YJsg5_module_style":"YJsgxhtml","YJsg6_module_style":"YJsgxhtml","YJsg7_module_style":"YJsgxhtml","admin_css_time":"1397666123","yjsg_assigements":""}');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `icancarry_ucm_base`
--

CREATE TABLE IF NOT EXISTS `icancarry_ucm_base` (
...
--
-- Volcado de datos para la tabla `icancarry_ucm_base`
--

INSERT INTO `icancarry_ucm_base` (`ucm_id`, `ucm_item_id`, `ucm_type_id`, `ucm_language_id`) VALUES
(1, 1, 1, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `icancarry_ucm_content`
--

CREATE TABLE IF NOT EXISTS `icancarry_ucm_content` (
...
--
-- Volcado de datos para la tabla `icancarry_updates`
--

INSERT INTO `icancarry_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
(1, 3, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/ru-RU_details.xml', '', ''),
(2, 3, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/sk-SK_details.xml', '', ''),
(3, 3, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/sv-SE_details.xml', '', ''),
(4, 3, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/sy-IQ_details.xml', '', ''),
(5, 3, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/ta-IN_details.xml', '', ''),
(6, 3, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/th-TH_details.xml', '', ''),
(7, 3, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/tr-TR_details.xml', '', ''),
(9, 3, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '3.2.0.6', '', 'http://update.joomla.org/language/details3/uk-UA_details.xml', '', ''),
(10, 3, 0, 'Uyghur', '', 'pkg_ug-CN', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/ug-CN_details.xml', '', ''),
(11, 3, 0, 'Albanian', '', 'pkg_sq-AL', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/sq-AL_details.xml', '', ''),
(12, 3, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/pt-BR_details.xml', '', ''),
(13, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.2.3.3', '', 'http://update.joomla.org/language/details3/sr-YU_details.xml', '', ''),
(14, 3, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/es-ES_details.xml', '', ''),
(15, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
(16, 3, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.2.3.2', '', 'http://update.joomla.org/language/details3/sr-RS_details.xml', '', ''),
(17, 3, 0, 'Vietnamese', '', 'pkg_vi-VN', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/vi-VN_details.xml', '', ''),
(18, 3, 0, 'Bahasa Indonesia', '', 'pkg_id-ID', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/id-ID_details.xml', '', ''),
(19, 3, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/fi-FI_details.xml', '', ''),
(20, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/sw-KE_details.xml', '', ''),
(21, 3, 0, 'Montenegrin', '', 'pkg_srp-ME', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/srp-ME_details.xml', '', ''),
(22, 3, 0, 'Malay', '', 'pkg_ms-MY', 'package', '', 0, '3.2.2.1', '', 'http://update.joomla.org/language/details3/ms-MY_details.xml', '', ''),
(23, 3, 0, 'Romanian', '', 'pkg_ro-RO', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/ro-RO_details.xml', '', ''),
(24, 3, 0, 'Flemish', '', 'pkg_nl-BE', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/nl-BE_details.xml', '', ''),
(25, 3, 0, 'Chinese Traditional', '', 'pkg_zh-TW', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/zh-TW_details.xml', '', ''),
(26, 3, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/fr-FR_details.xml', '', ''),
(27, 3, 0, 'German', '', 'pkg_de-DE', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/de-DE_details.xml', '', ''),
(28, 3, 0, 'Greek', '', 'pkg_el-GR', 'package', '', 0, '3.2.0.1', '', 'http://update.joomla.org/language/details3/el-GR_details.xml', '', ''),
(29, 3, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/ja-JP_details.xml', '', ''),
...
(32, 3, 0, 'EnglishUS', '', 'pkg_en-US', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/en-US_details.xml', '', ''),
(33, 3, 0, 'Hungarian', '', 'pkg_hu-HU', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/hu-HU_details.xml', '', ''),
(34, 3, 0, 'Afrikaans', '', 'pkg_af-ZA', 'package', '', 0, '3.2.0.1', '', 'http://update.joomla.org/language/details3/af-ZA_details.xml', '', ''),
(35, 3, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/ar-AA_details.xml', '', ''),
(36, 3, 0, 'Belarusian', '', 'pkg_be-BY', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/be-BY_details.xml', '', ''),
(37, 3, 0, 'Bulgarian', '', 'pkg_bg-BG', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/bg-BG_details.xml', '', ''),
(38, 3, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/ca-ES_details.xml', '', ''),
(39, 3, 0, 'Chinese Simplified', '', 'pkg_zh-CN', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/zh-CN_details.xml', '', ''),
...
(44, 3, 0, 'Estonian', '', 'pkg_et-EE', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/et-EE_details.xml', '', ''),
(45, 3, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/it-IT_details.xml', '', ''),
(46, 3, 0, 'Korean', '', 'pkg_ko-KR', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/ko-KR_details.xml', '', ''),
(47, 3, 0, 'Latvian', '', 'pkg_lv-LV', 'package', '', 0, '3.2.3.2', '', 'http://update.joomla.org/language/details3/lv-LV_details.xml', '', ''),
(48, 3, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/mk-MK_details.xml', '', ''),
(49, 3, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '3.2.2.1', '', 'http://update.joomla.org/language/details3/nb-NO_details.xml', '', ''),
(50, 3, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/fa-IR_details.xml', '', ''),
(51, 3, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/pl-PL_details.xml', '', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `icancarry_update_sites`
--

CREATE TABLE IF NOT EXISTS `icancarry_update_sites` (
...
--
-- Volcado de datos para la tabla `icancarry_update_sites`
--

INSERT INTO `icancarry_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1397665818, ''),
(2, 'Directorio de Extensiones Joomla', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1397665818, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1397665818, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `icancarry_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `icancarry_update_sites_extensions` (
...
--
-- Volcado de datos para la tabla `icancarry_update_sites_extensions`
--

INSERT INTO `icancarry_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Estructura de tabla para la tabla `icancarry_usergroups`
--

CREATE TABLE IF NOT EXISTS `icancarry_usergroups` (
...
--
-- Volcado de datos para la tabla `icancarry_usergroups`
--

INSERT INTO `icancarry_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Publico'),
(2, 1, 8, 15, 'Registrado'),
(3, 2, 9, 14, 'Autor'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Estructura de tabla para la tabla `icancarry_users`
--

CREATE TABLE IF NOT EXISTS `icancarry_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Volcado de datos para la tabla `icancarry_users`
--

INSERT INTO `icancarry_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`) VALUES
(620, 'Super Usuario', 'admin', 'jjlabradorglez@gmail.com', '$P$DWbnuFCe4D8zrDZ7QQU0WqQvhEb8sU.', 0, 1, '2014-04-16 16:27:41', '2014-04-16 16:30:12', '0', '', '0000-00-00 00:00:00', 0, '', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `icancarry_user_keys`
--

CREATE TABLE IF NOT EXISTS `icancarry_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `icancarry_user_notes`
--

CREATE TABLE IF NOT EXISTS `icancarry_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `icancarry_user_profiles`
--

CREATE TABLE IF NOT EXISTS `icancarry_user_profiles` (
...
--
-- Estructura de tabla para la tabla `icancarry_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `icancarry_user_usergroup_map` (
...
--
-- Volcado de datos para la tabla `icancarry_user_usergroup_map`
--

INSERT INTO `icancarry_user_usergroup_map` (`user_id`, `group_id`) VALUES
(620, 8);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `icancarry_viewlevels`
--

CREATE TABLE IF NOT EXISTS `icancarry_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `icancarry_viewlevels`
--

INSERT INTO `icancarry_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Publico', 0, '[1]'),
...
--
-- Estructura de tabla para la tabla `icancarry_weblinks`
--

CREATE TABLE IF NOT EXISTS `icancarry_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
